...
namespace AttnSoft.BarcodeHook
{
    internal class WinApi
    {
        ...
        public static class User32
        {
            ...
            //[DllImport("User32.dll", SetLastError = true)]
            //internal static extern uint GetRawInputDeviceInfo(IntPtr hDevice, GetRawDeviceInfoCommand command, IntPtr pData, ref uint size);
            //[DllImport("User32.dll", SetLastError = true)]
            //internal static extern uint GetRawInputDeviceInfo(IntPtr hDevice, GetRawDeviceInfoCommand command, StringBuilder pData, ref uint size);
